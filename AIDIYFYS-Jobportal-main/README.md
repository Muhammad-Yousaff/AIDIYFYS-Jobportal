...
Features:
- Reads uploaded resume files including PDF and Word (.docx).
- Extracts skills.
...
If you opened the outer workspace folder, first change into the app directory that contains `package.json`:
